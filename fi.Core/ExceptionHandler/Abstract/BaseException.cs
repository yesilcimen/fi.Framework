...
public abstract class BaseException : Exception
{
    ...
    public BaseException(ICollection<ErrorResult> errorResults, int statusCode, ResponseMessageType responseMessageType)
        : base(string.Join(Environment.NewLine, errorResults.Select(x => x.ToString())))
    {
