...
internal class AppDomain : LazySingleton<AppDomain>
{
    ...
    public ICollection<Assembly> GetAllAssemblies()
    {
        ...
        var files = Directory.GetFiles(path, "*.dll")
            .Where(i => !new[] { "Microsoft.", "System." }.Any(j => i.Contains(j)));
...
internal class TypeOfLifeCycle
{
    ...
    public Type LifeCycle => typeof(ITransientDependency).IsAssignableFrom(ImplementationType)
